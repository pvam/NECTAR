...
import java.awt.event.*;
	...
	public class BayesianRadioButton extends JRadioButton implements Command {
		 ...
		 */
		public BayesianRadioButton(ActionListener listener) {
			super("Bayesian Game");
			initGUI(listener);
		}
		...
		private void initGUI(ActionListener listener) {
			...
			mediator.registerBayesianRadioButton(this);
		...
		public void execute() {
			...
			mediator.bayesianSelected();//  ExtensiveFormGameSelected();
