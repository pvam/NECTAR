 ...
 * 
 */
public class ShowGameButton extends JButton implements Command {

	protected Mediator mediator = null;

	public ShowGameButton(ActionListener listener, Dimension dimension) {
		super();
	...
	private void initGUI(ActionListener listener, Dimension dimension) {
		...
		mediator.registerShowGameButton(this);

		Icon imageIcon = new ImageIcon("images/normalform.png");
		String toolTip = "Displays the Normal form game";
		String command = "show";
